...
class CustomerAdd extends React.Component {
    ...
    handleFormSubmit = (e) => {
        ...
        .catch(err => {console.log("customerAdd error = "+err)});
        ...
        return(
            <div>
                ...
                <Dialog open={this.state.open} onClose='this.handleClose'>
                    ...
                    <DialogContent>
                        ...
                        <label htmlFor="raised-button-file">
                            <Button variant="contained" color="primary" component="span" name="file">
                                {this.state.fileName ==="" ? "Pick a profile imaage file" : this.state.fileName}
                            </Button>
                        </label>
                        <br/>
                    ...
                    <DialogActions>
                        <Button variant="contained" color="primary" onClick={this.handleFormSubmit}>Run</Button>            
