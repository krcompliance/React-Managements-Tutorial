...
class CustomerDelete extends React.Component {
    ...
    render() {
        return(
            <div>
                ...
                <Dialog open={this.state.open} onClose={this.handleClose}>
                    <DialogTitle onClose={this.handleClose}>
                        Warning: you are trying to remove a customer information
                    </DialogTitle>
                    <DialogContent>
                        <Typography gutterBottom>
                            All data on [{this.props.name}] will be deleted.
                        </Typography>
                    </DialogContent>
                    <DialogActions>
            ...
            /*
            <button onClick={(e) => {this.deleteCustomer(this.props.id)}}>Delete Customer</button>
            */
        );
    }
}
